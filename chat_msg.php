...
while($v=mysql_fetch_object($query)){
	$msg = "";
	if($_GET['show']!='history'){
$nick="<a href='#' onmousedown=\"addSmiley('[ ".htmlentities($v->user, ENT_QUOTES, cp1251)." ]')\">".htmlentities($v->user, ENT_QUOTES, cp1251)."</a>";	}else{
	...
	$msg="<div align=\"left\" style='color:white;'><span style='font:menu;color:PaleGreen;'>[".$msgtimestamp."]</span> <span style='width:50px;font:menu;'><b>".$nick."</b></span> : ".$msg."<br></div>";
	$buff = $msg . $buff;
}
print $buff;
