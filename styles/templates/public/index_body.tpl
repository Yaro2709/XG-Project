    ...
    <div id="mainmenu" style="margin-top: 20px;">
        ...
        <div id="content">
        	<center>
                ...
                <div id="text2">
                    <div id="text3">
                        <center><b>{server_message} {servername}!</b></center><br>	
                    </div>
				<center><b>	
				<font color="FFFF00">{login_online}&nbsp;: </font><font color="lime">{online_users}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font color="FFFF00">{login_lastreg}&nbsp;: </font><font color="lime">{last_user}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font color="FFFF00">{login_numbreg}&nbsp;: </font><font color="lime">{users_amount}</font></b></center>
