...
<table width="80%">
    ...
    <tr>
        ...
        <table width="100%">
		<tr>
        <td class="k"><h3>Перевод на русский язык и дороботка осуществлены Администрацией сайта<br><a href="http://portal-soft.net.ru" target="_blank"><font size="4" color="lime"><b>Portal-Soft.Net.Ru</b></font</h3></td>
        </tr>
		</table>
        </th>
    </tr>
