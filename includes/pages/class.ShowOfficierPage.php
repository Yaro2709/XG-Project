		...
		else
		{
			...
			foreach($lang['tech'] as $Element => $ElementName)
			{
				...
				if ($Element >= 601 && $Element <= 604)
				{
					...
					if ( $Result )
					{
						$bloc['off_link']  = "<font color=\"lime\"><strong>".pretty_number ( $Price ) . '</strong><br />' . $lang['Darkmatter'] . "</font>";
						$bloc['off_link'] .= "<br /><a href=\"game.php?page=officier&mode=2&offi=".$Element."\"><font color=\"#00ff00\">".$lang['of_recruit']."</font>";
					}
					else
					{
						$bloc['off_link'] = "<font color=\"red\"><strong>".pretty_number ( $Price ) . '</strong><br />' . $lang['Darkmatter'] . "</font>";
					}
